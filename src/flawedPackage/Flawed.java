...
public class Flawed {
	...
	/*
	 * The `static final` modifier combo causes Java to optimize away needed scope information,
	 * making this flaw show up on Line 1 instead of the line actually exists on.
	 */
//	public static final String PASSWORD_1 = "pass";

	/*
	 * Removing the final modifier keeps the scope information intact
	 * so this flaw is on the "correct" line.
	 */
	public static String PASSWORD_2 = "pass";
